...
HidocModel hidocModelFromJson(String str) => HidocModel.fromJson(json.decode(str));

String hidocModelToJson(HidocModel data) => json.encode(data.toJson());
...
class HidocModel {
    ...
    factory HidocModel.fromJson(Map<String, dynamic> json) => HidocModel(
